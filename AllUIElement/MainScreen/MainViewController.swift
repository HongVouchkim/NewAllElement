...
class MainViewController: UIViewController {
	...
	let cellUI = ["Observer VM and VC", "UIGredientColor", "MapKet"]
...
extension MainViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		if indexPath.row == 0 {
			...
			let st = UIStoryboard.init(name: "GradientColorViewController", bundle: nil)
			let vc = st.instantiateViewController(withIdentifier: "GradientColorViewController")
